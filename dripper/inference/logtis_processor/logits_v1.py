...
class TokenStateMachine:
    ...
    def handle_end(self, input_ids: list[int], logits: 'torch.Tensor') -> 'torch.Tensor':
        """Handle End state.
    ...
    def handle_eos(self, input_ids: list[int], logits: 'torch.Tensor') -> 'torch.Tensor':
        """Handle EOS state.
    ...
    def handle_decide_main_other(self, input_ids: list[int], logits: 'torch.Tensor') -> 'torch.Tensor':
